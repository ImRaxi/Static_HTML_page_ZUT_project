...
<html>
    ...
    <body>
        <div id="box">
            ...
            <div id="content">
                <div id="prawa">
                    <a class="button" href ="login.html">Logowanie</a>
                    <a class="button" href="reje.html">Rejestracja</a>
                </div>	
              
              
                <a href="strona_glowna_niez.html"><img class="logo" src="IMG/logoskpn.png" alt="logo" /></a>
